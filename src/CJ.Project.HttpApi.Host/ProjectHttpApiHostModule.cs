    ...
    public class ProjectHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CJ.Project.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CJ.Project.Domain"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CJ.Project.Application"));
                });
            }
        }
