...
namespace CJ.Project.Web.Menus
{
    public class ProjectMenuContributor : IMenuContributor
    {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<ProjectResource>>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("Project.Home", l["Menu:Home"], "/"));
